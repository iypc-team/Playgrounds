...
class MotionDetector: ObservableObject {
    ...
    init(updateInterval: TimeInterval) {
        print("init(updateInterval: TimeInterval)")
        self.updateInterval = updateInterval
    }
    
    func start() {
        print("func start()")
        if MotionDetector.motionManager.isDeviceMotionAvailable {
            print("motionManager.isDeviceMotionAvailable:  \( MotionDetector.motionManager.isDeviceMotionAvailable  ) ")
    ...
    func updateMotionData() {
        print("func updateMotionData()")
        if let data = MotionDetector.motionManager.deviceMotion {
